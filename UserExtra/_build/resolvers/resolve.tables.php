...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('userextra_core_path', null,
                    $modx->getOption('core_path') . 'components/userextra/') . 'model/';
            $modx->addPackage('userextra', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/userextra/model/schema/userextra.mysql.schema.xml';
