...
class SchoolRatingHomeManagerController extends modExtraManagerController
{
    ...
    public function loadCustomCssJs()
    {
        ...
        $this->addJavascript($this->SchoolRating->config['jsUrl'] . 'mgr/widgets/grids/reports-users.grid.js');
        ...
        $this->addJavascript($this->SchoolRating->config['jsUrl'] . 'mgr/widgets/grids/winners.grid.js');
