...
class srActivitySectionRemoveProcessor extends modObjectProcessor
{
    public $objectType = 'srActivitySection';
    public $classKey = 'srActivitySection';
    public $languageTopics = array('schoolrating');
    //public $permission = 'remove';
    public $afterRemoveEvent = 'srOnActivitySectionRemove';
    ...
    public function process()
    {
        ...
        foreach ($ids as $id) {
            /** @var srActivitySection $this->object */
...
return 'srActivitySectionRemoveProcessor';