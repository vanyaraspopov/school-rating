...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('verifyphone_core_path', null,
                    $modx->getOption('core_path') . 'components/verifyphone/') . 'model/';
            $modx->addPackage('verifyphone', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/verifyphone/model/schema/verifyphone.mysql.schema.xml';
